...
public class BotonTropaDistancia extends Modelo implements BotonTropa {
    ...
    public void deseleccionar() {
        this.imagen = CargadorGraficos.cargarDrawable(getContext(), R.drawable.boton_distancia);
        this.selected = false;
    }

    @Override
    public void seleccionar() {
        this.imagen = CargadorGraficos.cargarDrawable(getContext()
                , R.drawable.boton_distancia_activo);
        this.selected = true;
    }

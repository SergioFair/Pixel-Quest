...
public class TropaDistanciaEnemigo extends AbstractTropa {
    ...
    public TropaDistanciaEnemigo(Context context, int drawable){
    ...
    private void inicializar(){
        ...
        Sprite actual = new Sprite(CargadorGraficos.cargarDrawable(getContext()
                , R.drawable.animacion_distancia_enemigo_mov) , getAncho(), getAlto()
                , 4, 4, true);
